...
//data attributes:
    String data_title="002_title";
    String data_username_input="002_username_input";
    String data_email_input="002_email_input";
    String data_pass_input="002_pass_input";
    String data_conf_pass_input="002_conf_pass_input";
    String data_sign_up_btn="002_sign_up_btn";
    String data_sign_in_link="002_sign_in_link";
    String data_gmail_sign_up_btn="002_gmail_sign_up_btn";
    String data_title_001="001_title";
    String data_error_mssg="error_mssg";
    ...
    public void iOpenRegistrationPage() throws InterruptedException {
     ...
     //   waiter = new WebDriverWait(driver,1000);
        ...
        boolean b = !(driver.findElementByCssSelector(data_username_input).isDisplayed()
                && driver.findElementByCssSelector(data_email_input).isDisplayed()
                && driver.findElementByCssSelector(data_pass_input).isDisplayed()
                && driver.findElementByCssSelector(data_conf_pass_input).isDisplayed()
                && driver.findElementByCssSelector(data_sign_up_btn).isDisplayed()
                && driver.findElementByCssSelector(data_gmail_sign_up_btn).isDisplayed());
        if(!b)  {
    ...
    public void iEnterValidUsername() {
        ...
        WebElement username_input = driver.findElementByCssSelector(data_username_input);
    ...
    public void iEnterValidEmail() {
        ...
        WebElement email_input = driver.findElementByCssSelector(data_email_input);
    ...
    public void iEnterValidPass() {
        ...
        WebElement pass_input = driver.findElementByCssSelector(data_pass_input);
    ...
    public void iEnterValidConfirmationPass() {
        WebElement pass_conf_input = driver.findElementByCssSelector(data_conf_pass_input);
    ...
    public void userClicksSignUpBtn() {
        WebElement signUpBtn = driver.findElementByCssSelector(data_sign_up_btn);
    ...
    public void systemProceedsWithRegistration() {
        boolean res=driver.findElementByCssSelector(data_title_001).isDisplayed();
        driver.quit();
    ...
    public void systemShowsErrorMessage() {
        boolean res=driver.findElementByCssSelector(data_error_mssg).isDisplayed();
        driver.quit();
        Assertions.assertEquals(true,res);
    }
    ...
    public void iSeeUsernameEMailPassConfirmPassFieldsSignUpAndSignUpButtons() {
                   boolean res=(driver.findElementByCssSelector(data_username_input).isDisplayed()
                    && driver.findElementByCssSelector(data_email_input).isDisplayed()
                    && driver.findElementByCssSelector(data_pass_input).isDisplayed()
                    && driver.findElementByCssSelector(data_conf_pass_input).isDisplayed()
                   && driver.findElementByCssSelector(data_sign_up_btn).isDisplayed()
